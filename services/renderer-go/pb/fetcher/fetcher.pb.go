...
var file_fetcher_proto_rawDesc = []byte{
	...
	,
...
var file_fetcher_proto_depIdxs = []int32{
	0, // 0: fetcher.Fetcher.Render:input_type -> fetcher.FetcherRequest
	1, // 1: fetcher.Fetcher.Render:output_type -> fetcher.FetcherReply
...
type FetcherClient interface {
	Render(ctx context.Context, in *FetcherRequest, opts ...grpc.CallOption) (*FetcherReply, error)
}
...
func (c *fetcherClient) Render(ctx context.Context, in *FetcherRequest, opts ...grpc.CallOption) (*FetcherReply, error) {
	out := new(FetcherReply)
	err := c.cc.Invoke(ctx, "/fetcher.Fetcher/Render", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FetcherServer interface {
	Render(context.Context, *FetcherRequest) (*FetcherReply, error)
}
...
func (*UnimplementedFetcherServer) Render(context.Context, *FetcherRequest) (*FetcherReply, error) {
...
func _Fetcher_Render_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fetcher.Fetcher/Render",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FetcherServer).Render(ctx, req.(*FetcherRequest))
	}
